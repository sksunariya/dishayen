      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link
            ...
            className="bg-white dark:bg-dark-elevated p-6 rounded-xl border border-gray-200 dark:border-dark-border hover:border-neon-blue shadow-lg hover:shadow-xl transition-all"
          >
            <FiGrid className="w-8 h-8 text-neon-blue mb-4" />
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Manage Results</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">Upload images &amp; videos showcasing student results</p>
          </Link>
        </div>
